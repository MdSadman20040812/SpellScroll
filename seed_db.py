...
# Seed the database with the seed data from webtoon_scraper.py
WEBTOON_SEED_DATA = [
    {
        "title": "Lore Olympus",
    ...
    },
    {
        ...
        "colour_rating": 0.88,
        "popularity_rank": 5,
        "mangadex_id": "4ada20eb-085a-491a-8c49-477ab42014d7",
...
print(f"Seeded {count} webtoons. Total active: {total}")
